const VisaSVGComponent = (props) => (
    <svg viewBox="0 0 256 83" xmlns="http://www.w3.org/2000/svg" {...props}>
        <defs>
            <linearGradient
                x1="45.974%"
                y1="-2.006%"
...
export default VisaSVGComponent;
